...
public class ScaleFilter {
    ...
    public static void createThumbnail(File file, int thumbnailWidth, int thumbnailHeight, File targetFile) {
        try {
    ...
    public static void compressImage(File sourceFile, Integer width, File targetFile, Boolean delSource) {
        try {
            ...
            ProcessUtils.executeCommand(String.format(cmd, sourceFile, width, targetFile), true);
            if (delSource) {
    ...
    public static void main(String[] args) {
        compressImageWidthPercentage(new File("H:\\test\\test003.png"), new BigDecimal(0.7), new File("H:\\test\\test00302.png"));
    }
}